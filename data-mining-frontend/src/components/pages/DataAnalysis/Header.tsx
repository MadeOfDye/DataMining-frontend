  ...
  return (
    <div className="pl-10 border-b-2 border-black">
      ...
      <span className="text-lg italic font-bold text-gray-600">
        ...
        <span className="pr-3 hover:text-black cursor-pointer" onClick={()=>setPage(2)}>Model Comparison</span>
        <span className="underline pr-3 cursor-pointer" >Data Analysis</span>
      </span>
      <br />
      <br />
    </div>
